...
class PermissionCatalog
{
    ...
    public static function all(): array
    {
        return [
            ...
            'accounting.ledger.suppliers.voir' => ['accountant', 'manager'],
            'accounting.ledger.voir' => ['accountant', 'manager'],
            ...
            'accounting.voir' => ['accountant', 'manager'],
            ...
            'economat.items.export' => ['econome', 'manager'],
            ...
            'economat.orders.voir' => ['econome', 'manager'],
            ...
            'economat.requisitions.voir' => ['econome', 'housekeeping_leader', 'manager', 'reception', 'restaurant_chief', 'shop_manager'],
            ...
            'economat.suppliers.voir' => ['econome', 'manager'],
            'economat.voir' => ['econome', 'manager'],
