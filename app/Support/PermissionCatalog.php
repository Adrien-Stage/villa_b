...
class PermissionCatalog
{
    ...
    public static function all(): array
    {
        return [
            ...
            'restaurant.billing.receipt' => ['cashier', 'restaurant_chief'],
            ...
            'accounting.expenses' => ['accountant'],
            'accounting.expenses.creer' => ['accountant'],
            'accounting.expenses.modifier' => ['accountant'],
            'accounting.expenses.supprimer' => ['accountant'],
            'accounting.income_statement' => ['accountant'],
            'accounting.journal' => ['accountant'],
            'accounting.ledger.accounts' => ['accountant'],
            'accounting.ledger.aged' => ['accountant'],
            'accounting.ledger.analytic' => ['accountant'],
            'accounting.ledger.analytic.margins' => ['accountant'],
            'accounting.ledger.analytic.mirror' => ['accountant'],
            'accounting.ledger.auxiliary' => ['accountant'],
            'accounting.ledger.auxiliary.ledger' => ['accountant'],
            'accounting.ledger.balance' => ['accountant'],
            'accounting.ledger.entry' => ['accountant'],
            'accounting.ledger.entry.reverse' => ['accountant'],
            'accounting.ledger.general' => ['accountant'],
            'accounting.ledger.journals' => ['accountant'],
            'accounting.ledger.night_audit' => ['accountant'],
            'accounting.ledger.night_audit.run' => ['accountant'],
            'accounting.ledger.opening' => ['accountant'],
            'accounting.ledger.opening.creer' => ['accountant'],
            'accounting.ledger.periods' => ['accountant'],
            ...
            'accounting.ledger.suppliers' => ['accountant'],
            ...
            'accounting.ledger.withholding' => ['accountant'],
            'accounting.ledger.years.open' => ['accountant'],
            'accounting.receivables' => ['accountant'],
            ...
            'economat.requisitions.creer' => ['econome', 'housekeeping_leader', 'reception', 'restaurant_chief', 'shop_manager'],
            ...
            'shop.orders.receipt' => ['shop_cashier', 'shop_manager'],
